...
* *[.underline]##C##ancel* to close the window and to return to the *_OPD Out Patient Department_* window.
...
* *[.underline]##N##o* to close the window and return to the to the *_OPD Out Patient Department_* window without deleting the visit.
...
* *Stoc[.underline]##k##Card*: show the movements history for a certain pharmaceutical (you must select it in the list first)
...
* *[.underline]##C##ancel* to close the window and return to the *_Pharmaceutical Browser_* window.

===== 6.1.2.2 Modify an Existing Pharmaceutical ([.underline]##E##dit)

Press the *[.underline]##E##dit* button in the *_Pharmaceutical Browser_* window to access the *_Edit Medical_* window shown below. You can modify all data except for the “Type” value.
...
* *[.underline]##O##K*: to confirm and save the data.
* *[.underline]##C##ancel*: to close the window and return to to the *_Pharmaceutical Browser_* window.
...
* *[.underline]##N##o*: to close the window and return to to the *_Pharmaceutical Browser_* window.

===== 6.1.2.4 Export the List of Pharmaceuticals (E[.underline]##x##port)

Use this function to export the list of pharmaceuticals shown in the *_Pharmaceutical Browser_* window that can be imported into Excel.
...
The Pharmaceutical Stock feature helps you store and trace every stock movement that has been made. Every movement is identified by the following data:
...
* *[.underline]##C##lose*: to exit the *_Stock Movement Browser_* window
...
* *_Type_*: specifies if it is a charge or a discharge type. If you select the discharge option, then the ward combo box gets enabled. The ward combo box allows you to find any discharging movements that refer to a specific ward.
...
The grid is filled with the pharmaceuticals involved in the charging movement. To fill the grid, use the field above the grid to select pharmaceutical. Enter into field the code or the description of the pharmaceutical to move, and
...
To insert discharging movements, you have to press *[.underline]##D##ischarge* in the *_Stock Movement Browser_* window. The *_Stock Movement_* window shown below appears. You can enter discharging movements.
...
The grid should be a filled in with pharmaceuticals involved in the discharging movement. To fill the grid, you have to use the field above the grid to select a pharmaceutical. Enter into the field the description of the pharmaceutical, and
press *ENTER.* This will open the *_Choose a Medical_* window.
...
* If lots exist for the drug, click *Choose a Lot*, otherwise, click on *New Lot* (you are detecting a new lot)
...
The counter at the bottom will automatically display the number of movements that match the filtering criteria after clicking the *[.underline]##F##ilter* button.
...
=== 9.2 Functions of Patient Vaccines
