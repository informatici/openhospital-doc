...
* *Date*: the date when the physical check for this inventory has been done in the main store.
+
...
During modification it is possible to validate the inventory by clicking on *[.underline]##V##alidate* button.  This results in the following dialog:
