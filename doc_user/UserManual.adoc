...
* *[.underline]##O##K*: confirm and save the data.
* *[.underline]##C##ancel*: close the window and return to to the *_Pharmaceutical Browser_* window.
...
The *Grid* is filled in with pharmaceuticals involved in the discharging movement. To fill the grid, you have to use the field above the grid to select a pharmaceutical. Enter into the field the description of the pharmaceutical, and
press *ENTER.* This will open the *_Choose a Medical_* window.
...
* *[.underline]##R##ectify*: rectify the quantity lying in stock (6.3.2.1 Rectify)
...
* *[.underline]##D##elete Bill*: delete a stored bill
* *Recei[.underline]##p##t*: print a bill receipt
* *[.underline]##R##eport*: print a variety of reports
* *[.underline]##C##lose*: to exit from *_Patients Bills Management_* and return to the main menu
...
* *[.underline]##O##ther*: enter other prices defined in the Price List
* *[.underline]##C##ustom*: enter custom items defined on the fly
...
* *Vaccine type*: selection of a Vaccine Type to filter the Vaccine list
...
* *[.underline]##O##K*: confirm new values (all the previous values will be lost)
* *[.underline]##C##ancel*: close the window and to return to the Menu without applying any change
...
* *[.underline]##E##xamination*: open the *_Examination_* window (See
