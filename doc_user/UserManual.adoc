...
* *Date*: the date where the inventory was entered into the system.
...
Press the *[.underline]##N##ew* button in the *_Inventory Browser_* window to access the *_New Inventory_* window.
...
* *Supplier*: the supplier tsed for the charge movement.
...
*NOTE:* This button is enable just for the inventory row that column *New Lot* has value *N*, otherwise the button is disabled.
