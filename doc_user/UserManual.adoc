...
===== 8.10.8.1 Visits rules

A patient visit is valid if it does not overlap with:
...
NOTE: The section <<visit-validation-rules>> describes the constraints to create a valid appointment/visit.
