...
Then click on *[.underline]##O##k* button to insert all the pharmaceuticals that match the choise as the inventory(ies) row(s) in the *Inventory row table*.
...
The data shown in the *Center panel* area represente inventory row. they are:
...
During modication We have possibility to validate the inventory by clicking on *[.underline]##V##alidate* button. After some secondes We will have the dialog below.

image:image266.png[Validate Inventory]

During modication we have also possibility to Confirm the inventory by clicking on *[.underline]##C##onfirm* button. After some secondes we will have the dialog below.

image:image267.png[Confirm Inventory]

===== 4.5.2.3 View Ward Inventory ([.underline]##V##iew)

To view an ward inventory, highlight the inventory in the *_Manage Ward Inventory_* window. Once the inventory has been highlighted, click on *[.underline]##V##iew* button to enter on the *_View Inventory_* window. 
...
To print the inventory, click on *[.underline]##P##rint* button to print the data, shown the im below
...
The delete button is used to cancel an inventory. Highlight the inventory in the *_Inventory Browser_* window, wwhen the inventory has been highlighted then click on *[.underline]##D##elete* button on the *Buttons panel*. A confirmation window is shown:
