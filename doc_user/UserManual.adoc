...
* *Theoretic Qty*: the theoretic quantity of the lot of the pharmaceutical.
* *Real Qty*: the real(physical) quantity of the lot of the pharmaceutical.
...
=======
To insert an inventory row for a set of products, click on the [.underline]##S##elect* button. This will open the *_Lot Information_* window.
>>>>>>> 9498ba66784ec72fb385c147d2be1372eed2b7e8
