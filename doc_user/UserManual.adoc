...
Deleted MedicalType will be marked as “Deleted” and will not be shown in the list of Medical Types throught the application. User cannot mark a MedicalType as “Deleted” if it is still used somewhere in the application.
