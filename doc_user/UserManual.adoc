...
The grid should be filled in with pharmaceuticals involved in the discharging movement. To fill the grid, you have to use the field above the grid to select a pharmaceutical. Enter into the field the description of the pharmaceutical, and
press *ENTER.* This will open the *_Choose a Medical_* window.
