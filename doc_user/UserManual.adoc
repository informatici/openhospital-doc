...
* In the case the selected patient needs updates to his/her personal data, you can do it by clicking on the Edit icon image:image15.png[Edit icon,width=26,height=26] near his/her name; a new window appears with the patient personal information available for modification.
...
image:image18.png[New Medical,width=350,height=263]
...
image:image19.png[Edit Medical,width=350,height=280]
...
image:image25.png[Stock Movement Charging,width=512,height=384]
...
image:image31.png[Stock Movement Discharging,width=463,height=347]
...
image:image33.png[Existing Lot,width=379,height=378]
...
image:image34.png[Ward Pharmacy,width=616,height=347]
...
image:image35.png[Ward Pharmacy,width=614,height=346]
...
image:image43.png[Laboratory Browser,width=528,height=339]
...
This functionality is used to generate reports about the hospital like a list of exams, diseases, etc.
...
By pressing *[underline]##R##eports* from the main menu, you access the *_Reports_* menu. From this menu you have the following printings available: *[.underline]##E##xams List* and *[.underline]##D##isease List.*
...
* *[.underline]#Printing#*: print the current price list
