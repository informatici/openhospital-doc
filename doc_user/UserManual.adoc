...
+
*NOTE:* The Destination, Charge Type, Discharge Type and Supplier can be defined by the Administrator. Ask the Administrator or check the <<settings,Settings>> chapter.
