...
NOTE: it is possibile to double-click an item on any table to automatically restrict the Clinical Sheet report to the selected date ranges and item's category. 
