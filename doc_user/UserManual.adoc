...
To delete the last movement, select first the row that you want to delete and press the *[.underline]##D##elete* button in the *_Stock Movement Browser_* window. if it is not the last movement you will have and *_Warning_* window:

image:image250.png[Warning]

But, if the row selected is the last movement you will have the *_Question_* window:

image:image248.png[Question]

Click *[.underline]##Y##es* if you realy want to delete the last movement or click *[.underline]##N##o* if no. Before click the *[.underline]##Y##es* button to be sure that the product present in the last movement is not used in the *_Pharmaceuticals Stock [.underline]##W##ard_*
