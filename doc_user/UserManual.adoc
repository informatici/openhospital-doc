...
NOTE: Disease Types are defined by the Administrator. Ask your Administrator how to do it or see
...
When you finish entering data the *Buttons panel* has the following choices:

* *[.underline]##O##K* to confirm and record the patient's visit
* *[.underline]##C##ancel* to close the window and return to the Menu

==== 5.2.3 Modify a Recorded Patient Visit ([.underline]##E##dit)

In order to modify a visit you have to highlight it in the *_OPD Out Patient Department_* window. Once a visit is highlighted,
...
In order to delete a visit you have to highlight it in the *_OPD Out Patient Department_* window.
Once a visit is highlighted, press the *[.underline]##D##elete* button. The highlighted record will be shown in the
...
* *[.underline]##Y##es* to confirm the deletion of the visit
* *[.underline]##N##o* to close the window and return to the previous window without deleting the visit
...
* Registered Patient (3): before choosing a disease, you *MUST* first select a patient from the drop-down list; you can also search for the patient with the search field nearby by typing part of its name or code; this will improve reliability for reports and statistics, and thus service to the patient by knowing his/her history.
* Once the patient is selected and a previous OPD visit is found, special fields are populated with the most recent visit of the patient (4), his/her personal data (5), and the Re-Attendance checkbox will be selected automatically (6);
* You can now set the next appointment date (7). This automatically schedules a visit visible in *_Therapy Management_*.
...
* In the case the selected patient needs updates to his/her personal data, you can do it by clicking on the Edit icon image:image15.png[edit_button.png,width=26,height=26] near his/her name; a new window appears with the patient personal information available for modification.
* In case the patient is not yet registered, the *_<new patient>_* entry can be selected to let you register a new patient; after registration you are returned to the OPD window and the new patient will be selected.
...
* the expiring drugs today or a withing a time period
...
* *[.underline]##E##dit* to modify a registered pharmaceutical
...
* *Ex[.underline]##p##iring* to show the list of pharmaceuticals that are going to expire (today, next month, within two months, within three months, or within another month to be specified)
* *A[.underline]##M##C* to show the Average Monthly Consumption of pharmaceuticals
* *[.underline]##C##lose* to exit from the *Pharmaceuticals Browser*
...
* *PcsXPck*: Piece per packet (if more than 1)
...
When you finish entering the data, the *Buttons panel* has the following choices:

* *[.underline]##O##K* to confirm and save the data
* *[.underline]##C##ancel* to close the window and return to the Menu

===== 6.1.2.2 Modify an Existing Pharmaceutical ([.underline]##E##dit)

Press the *[.underline]##E##dit* button in the *_Pharmaceutical Browser_* window to access the *_Edit Medical_* window shown below. You can modify all data except for “Type” value.
...
To delete a pharmaceutical, you have to highlight it in the Browser window as before. Next, press the *[.underline]##D##elete* button and a confirmation dialog appears:

image:image20.png[image,width=308,height=128]

In the *Buttons panel* you have the following choices:

* *[.underline]##Y##es* to confirm the deletion of the pharmaceutical
* *[.underline]##N##o* to close the window and return to the previous window without deleting the pharmaceutical
...
Press the *E[.underline]##x##port* button in the *_Pharmaceutical Browser_* window to access the *_Save_* window shown below. It will be in the language of your computer, regardless of the language used in Open Hospital.
...
show the movements history for a selected pharmaceutical for a specific time range.
...
* *C[.underline]##h##arge* to record a new charge movement
* *[.underline]##D##ischarge* to record a new discharge movement
...
* *Stock [.underline]##L##edger* to show the movements history for all pharmaceuticals within a selected date range
* *[.underline]##C##lose* to exit from the *_Stock Movement Browser_* window
...
As far as *Movement* is concerned, a user can choose its:

* *_Type_*: it specifies if it is a charge or a discharge type. If you select the discharge option, then the ward combo box gets enabled. The ward combo box allows you to find any discharging movements that refer to a specific ward.
* *_Date_*: you can choose a time frame between ‘Date from’ and ‘Data to’. The date tools consist of three blank areas, which (from left to right) refer to day, month and year. As you insert a value into a blank area, one can move to the next area by typing the “Tab” key on the keyboard. When first displayed the window is set to specify the previous week by default.

Finally, as far as *Lot Preparation Date* and *Lot Due Date* you can search movements that refer to specific lots by inserting:
...
After have chosen, press the *[.underline]##F##ilter* button. The system will show in the *Data table* area the results of the search using the specified criteria.

===== 6.2.2.2 Insert Stock Charging Movement ([.underline]##C##harge)

To insert charging movements, press *[.underline]##C##harge* in the *_Stock Movement Browser_* window. The *_Stock Movement_* window shown below appears. You can enter charge movements.

image:image25.png[Charging Movement,width=512,height=384]
...
The grid should be a filled with the pharmaceutical involved in the charging movement. To fill the grid, use the field above the grid to select pharmaceutical. Enter into field the code or the description of the pharmaceutical to move, and
press *ENTER.* This will open the *_Choose a Medical_* window.

image:image26.png[Medical Selection,width=355,height=343]

Select the desired medical and click *[.underline]##Y##es*. This will open a window where you will enter the quantity of the medical:
...
image:image28.png[Existing Lots,width=325,height=323]
...
image:image29.png[Lot Information,width=422,height=158]

Enter the appropriate values and then press the *[.underline]##O##K* button. The *_Input_* window appears and you next fill in the unit cost.

image:image30.png[UnitCost Input,width=310,height=137]
...
To insert charging movements, you have to Press *[.underline]##D##ischarge* in the *_Stock Movement Browser_* window. The *_Stock Movement_* window shown below appears. You can enter discharging movements.

image:image31.png[Charging Movement,width=463,height=347]
...
The grid should be a field with pharmaceuticals involved in the discharging movement. To fill the grid, you have to use the field above the grid to select a pharmaceutical. Enter info the field the description of the pharmaceutical, and
press *ENTER.* This will open the *_Choose a Medical_* window.

image:image26.png[Medical Selection,width=423,height=409]

Select the desired medical and click *[.underline]##Y##es*. This will open the *_Quantity_* window showing the existing stock for the medical. You will enter the quantity of the medical to discharge.

image:image32.png[Quantity Input,width=268,height=135]

Then press *[.underline]##O##K*. The *_Lot Information_* window will appear.

image:image33.png[Existing Lot Window,width=379,height=378]
...
After the selection of the ward (FEMALE WARD in this example), the *_Ward Pharmacy_* window appears as shown below and you can start the management of the ward pharmacy of the FEMALE WARD.
...
* *[.underline]##E##xcel*: export the data to Excel
...
* *Stock [.underline]##L##edger* to show the movements history for all pharmaceuticals within a selected date range
* *[.underline]##C##lose* to exit from the *_Ward Pharmacy_* window
...
image:image36.png[Rectify,width=576,height=224]

* Select the medical. Once done, the quantity currently in stock is displayed.
* If lots exists for the drug, click *Choose a Lot*, otherwise, click on *New Lot* (you are detecting a new lot)
* Modify the *Actual Quantity*
* Enter the reason for the rectification

image:image37.png[Rectify filled,width=574,height=224]
...
image:image38.png[WardPharmacy Filter,width=173,height=259]

The *Filter Panel* allows you to filter registered movements by:
...
The counter at the bottom will automatically count how many movements match the filtering criteria after clicking the *[.underline]##F##ilter* button.

The *Re[.underline]##s##et* button reset all the values in the Filter panel back to their default values as shown in the figure above.
...
image:image39.png[WardPharmacy New,width=456,height=424]
...
* *[.underline]##E##dit Bill* to modify a stored bill if its status is “O” (Open)
* *[.underline]##D##elete Bill* to delete a stored bill
...
* *[.underline]##O##ther* to enter other prices defined in the Price List
...
* *[.underline]##E##dit* to modify a stored vaccination
* *[.underline]##D##elete* to delete a stored vaccination
...
* *[.underline]##E##dit Patient* to modify an existing patient
* *Dele[.underline]##t##e Patient* to delete an existing patient
...
* *[.underline]##D##ELETE*: to delete an existing admission
...
* *[.underline]##T##ypes*: to define and manage the various _types_ listed in the menu
...
* *Disease [.underline]##T##ype*: the way similar diseases are grouped +
...
* *DICOM Type*: the way similar DICOM types are grouped +
...
image:image140.png[Admission Types,width=453,height=203]

The functions available in this window (similar to other windows in the *_Types_* menu) are:

* *[.underline]##N##ew*: to enter a new type (cannot use an existing code)
* *[.underline]##E##dit*: to edit an existing type (the code cannot be changed)
* *[.underline]##D##elete*: to delete an existing type (cannot be deleted if it is still used somewhere in the application)
* *[.underline]##C##lose*: to close the window

The Admission Types defined in this functionality are used in the Admission function (see
...
Once the *[.underline]##D##ischarge Type* button from the *_Types_* menu is pressed, the *_Discharge Type Browser_* window shown below appears:

image:image141.png[Discharge Types,width=453,height=203]

The functions available in this window (similar to other windows in the *_Types_* menu) are:

* *[.underline]##N##ew*: to enter a new type (cannot use an existing code)
* *[.underline]##E##dit*: to edit an existing type (the code cannot be changed)
* *[.underline]##D##elete*: to delete an existing type (cannot be deleted if still used somewhere in the application)
* *[.underline]##C##lose*: to close the window

The Discharge Types defined in this functionality are used in the Admission function (see
<<start-the-admission-of-a-patient,Start the admission of a patient>> and
<<discharge-of-a-patient,Discharge of a patient>> in this document).
...
image:image142.PNG[Discharge Types,width=453,height=203]
...
The Delivery Types defined in this functionality are used in the Admission function (see
...
image:image143.png[Discharge Result Types,width=453,height=203]
...
The Delivery Result Types defined in this functionality are used in the Admission function (see
<<insert-or-modify-delivery-data,Insert or Modify Delivery data>> in this document).

==== 14.2.5 Disease Types (Disease [.underline]##T##ype)

Once the *Disease [.underline]##T##ype* button from the *_Types_* menu is pressed, the *_Disease Type Browser_* window shown below appears:

image:image144.PNG[Disease Type,width=453,height=203]
...
The Disease Types defined in this functionality are used throughout the application. For example, in definition of Diseases or in OPD (see
...
image:image145.png[Exam Type,width=453,height=203]
...
The Exam Types defined in this functionality are used in the Laboratory function (see
...
image:image146.png[Medicals Stock Movement Types,width=453,height=203]
...
image:image147.png[New Medical Stock Movement,width=250,height=227]
...
The Medical Stock Movement Types defined in this functionality are used in the Pharmaceutical Stock function (see
<<#insert-stock-discharging-movement,Insert Stock Discharging Movement>> in this document).

==== 14.2.8 Medical Types ([.underline]##M##edicals Type)
...
image:image148.png[Medical Type,width=453,height=203]
...
The Medical Types defined in this functionality are used throughout the application. For example,
...
image:image149.png[Operation Types,width=453,height=203]
...
The Operation Types defined in this functionality are used in the Admission function (see
...
Once the *[.underline]##P##regnant Treatment Type* button from the *_Types_* menu is pressed, the *_Pregnant Treatment Type Browser_* window shown below appears:

image:image150.png[Pregnant Treatment Types,width=453,height=203]
...
The Pregnant Treatment Types defined in this functionality are used in the Admission function (see
<<insert-or-modify-delivery-data,Insert or Modify Delivery data>> in this document).
...
image:image151.png[Other Prices,width=377,height=194]

The functions available in this window (similar to other windows in the *_Types_* menu) are:

* *[.underline]##N##ew*: to enter a new price (cannot use an existing code)
* *[.underline]##E##dit*: to edit an existing price (the code can be changed)
* *[.underline]##D##elete*: to delete an existing price (cannot be deleted if still used somewhere in the application)
* *[.underline]##C##lose*: to close the window

To create a new Price, press the *[.underline]##N##ew* button, and the *_New Price_* window shown below appears:

image:image152.png[New Price,width=400,height=180]
...
The Other Prices defined in this functionality are used in the Accounting and Price List functions (see
...
image:image155.png[Age Types,width=456,height=170]
...
image:image156.png[Age Types_edit,width=456,height=170]
...
image:image157.png[Not Contiguous,width=642,height=313]

In following example, the ranges _Late Childhood_ and _Adolescent_ *overlap* since both start with age 6:

image:image159.png[Overlapped,width=642,height=313]

The Age Types defined in this functionality are used in the Patient Extended functionality (see
...
image:image161.png[Vacine Type,width=453,height=203]
...
The Vaccine Types defined in this functionality are used in the Vaccine function (see
<<vaccines,Vaccines>> in this document).

[#dicom-types]
==== 14.2.14 DICOM Types (DICOM Type)

Once the *DICOM Type* button in the *_Types_* menu is pressed, the *_DICOM Type Browser_* window shown below appears:

image:image242.png[DICOM Types,width=432,height=194]
...
The DICOM Types defined in this functionality are used in the DICOM Load function (see
...
* *[.underline]##N##ew*: to enter a new ward (cannot use an existing code)
* *[.underline]##E##dit*: to edit an existing ward (the code cannot be changed)
* *[.underline]##D##elete*: to delete an existing ward (cannot be deleted if still used somewhere in the application)
* *[.underline]##C##lose*: to close the window

By pressing the *[.underline]##N##ew* button, you access the *_New Ward_* window as shown below:

image:image165.png[Ward Browser_new,width=336,height=355]
...
The Wards defined in this functionality are used throughout the entire application. See for example, the Admission module, Pharmaceuticals Stock and Pharmaceuticals Stock Ward (see
...
* *[.underline]##N##ew*: to enter a new disease (cannot use an existing code)
* *[.underline]##E##dit*: to edit an existing disease (the code and type cannot be changed)
* *[.underline]##D##elete*: to delete an existing disease (it is set as not present in OPD or in IPD)
* *[.underline]##C##lose*: to close the window
...
* *Search*: you may filter the list by typing a keyword.
* *Selected Type*: you may filter the list by selecting only one Exam Type
* *[.underline]##N##ew*: to enter a new exam (cannot use an existing code)
* *[.underline]##E##dit*: to edit an existing exam (the code and type cannot be changed)
* *[.underline]##D##elete*: to delete an existing exam (it is set as not present in OPD or in IPD)
...
image:image169.png[Exam Browsing_edit,width=373,height=240]
...
image:image170.png[Exam Browsing_new,width=373,height=240]
...
exam can have. First select the exam in the *_Exam Browser_* window and then press the *Re[.underline]##s##ults* button.
...
image:image171.png[Proc 1,width=321,height=181]image:image171b.png[Proc 2,width=321,height=181]


The functions available in both windows are:

* *[.underline]##N##ew*: to enter a new result
* *[.underline]##D##elete*: to delete a defined result
* *[.underline]##C##lose*: to close the window
...
image:image173.png[Operations,width=600,height=337]

The functions available in this window are:

* *Selected type*: you may filter the list by selecting only one Operation Type
* *[.underline]##N##ew*: to enter a new operation (cannot use an existing code)
* *[.underline]##E##dit*: to edit an existing operation (the code and type cannot be changed)
* *[.underline]##D##elete*: to delete an existing operation (it is set as not present in OPD or in IPD)
* *[.underline]##C##lose*: to close the window
...
The Operations defined in this functionality are used throughout the entire application, like in the Admission module (see
<<insert-or-modify-surgery-data,Insert or Modify Surgery data>> in this document).
...
* *[.underline]##N##ew*: to enter a new vaccine (cannot use an existing code)
* *[.underline]##E##dit*: to edit an existing vaccine (the code and type cannot be changed)
* *[.underline]##D##elete*: to delete an existing vaccine (it is set as not present in OPD or in IPD)
* *[.underline]##C##lose*: to close the window
...
The vaccines defined in this functionality are used throughout the entire application, like in the Vaccine module (see
<<vaccines,Vaccines>> in this document).
...
* *[.underline]##S##ave*: to save any modifications made to the price list
...
* *Manage Lists*: you can define how many and which price list will be available in the application (see
...
image:image178.png[Price Browser_saved,width=268,height=118]
...
* *[.underline]##N##ew*: to enter a new price list
* *Co[.underline]##p##y*: to create a new price list as a copy of another one
* *[.underline]##E##dit*: to edit an existing price list
* *[.underline]##D##elete*: to delete an existing price list
* *[.underline]##C##lose*: to close the window
...
image:image180.png[List Browser_copy,width=317,height=118]
...
The lists defined in this functionality are used in the Accounting module (see
<<insert-a-new-bill,Insert a new bill>> in this document).

=== 14.10 Supplier ([.underline]#Supplier#)

Once the *S[.underline]##upplier##* button in the *_Settings_* menu is pressed, the *_Supplier Browser_* window shown below appears:
...
* *[.underline]##N##ew*: to send a new SMS
* *[.underline]##D##elete*: to delete an SMS
* *[.underline]##C##lose*: to close the window
...
* *[.underline]##E##dit*: to edit an existing group (only the description can be changed)
* *[.underline]##N##ew*: to enter a new group
* *Group[.underline]##M##enu*: to define rights and permission for a selected group
* *[.underline]##D##elete*: to delete an existing group
* *[.underline]##C##lose*: to close the window
...
* *[.underline]##N##ew*: to enter a new user (cannot use the same name)
* *[.underline]##E##dit*: to edit an existing user (the group cannot be hanged)
* *[.underline]##R##eset Password*: to change the password for an existing user
* *[.underline]##D##elete*: to delete an existing user
* *[.underline]##C##lose*: to close the window
