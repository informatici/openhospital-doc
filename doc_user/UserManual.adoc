...
To view an inventory, highlight the inventory in the *_Inventory Browser_* window. Once the inventory has been highlighted and click on *[.underline]##V##iew* button to enter on the *_View Browser_* window. 
...
To print the inventory, click on *[.underline]##P##rint* button to print the data, See the image below:
...
The delete button is used to cancel an inventory. Highlight the inventory in the *_Inventory Browser_* window, when the inventory has been highlighted then click on *[.underline]##D##elete* button. A confirmation window is shown:
