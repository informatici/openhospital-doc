...
* *Number*: the recipient of the SMS. You can select a patient by clicking the button image:image186.png[button.PNG,width=43,height=23]. The phone number of the selected patient will be automatically inserted.
