...
* *[.underline]##O##K*: confirm the data of the therapy. The therapy is automatically saved.
...
The removing of a therapy is not effective until it is confirmed with *[.underline]##S##ave* button (see <<save-function-therapy,Save function>>).
...
Briefly, the SMS notification will work in the following way:
...
* *Duration (Min)*: the estimated duration of the service that will be provided (optional, default is 30min)
* *Date*: the date and the time for the appointment

Rhe appointment is automatically saved and it will be shown in the calendar, along with the therapies.
