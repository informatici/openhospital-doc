...
- *Ward Inventory*: this feature is used to manage stock levels within individual wards of the hospital. The specifics of Ward Inventory management are explained in <<inventory-ward,Ward Inventory>>.

[#inventory-main-characteristics]
==== 4.4.1 Main Characteristics

The Inventory feature is used to manage stock levels in the *_Main Store_* as the hospital's central storage area.
...
- (Action) Status workflow: (Save) DRAFT -> (Validate) VALIDATED -> (Confirm) DONE
- Full freedom of charge/discharge type and supplier/destination selection (to be defined by the Administrator)
...
Click on the *[.underline]##I##nventory* button in the *Pharmacy* menu to access the *_Inventory Browser_* window. By default, the system shows all the inventories recorded in the period.
...
The _Ward Inventory_ feature is used to manage the stock levels in a *_Ward_*.
...
All the features available under *[.underline]##W##ard Inventory* are accessible from the *_Manage Ward Inventory_* window. By default, the system shows all the inventories recorded in the period.
