...
after ten days to have his/her stitches removed, a new OPD record is then created but without the NEW ATTENDANCE flag set._
 +
* *Attendence Date*: The date on which the patient is seen for the recorded activity.
...
* If a new attendance for this patient is required, click the "New Attendence" (6) check box and proceed normally.
* If editing an old OPD it is possible to change everything except the patient, which the OPD refers to, and the "New Attendence" check box.
