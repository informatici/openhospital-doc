...
To record a new patient, the following fields are avialable:
...
* *[.underline]##C##lose* to exit from the function *_Patient_* *_Data_* and return to the *_Patient Browser_* window
