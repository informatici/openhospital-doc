...
Consent from a patient is needed regardless of the procedure, whether it's a physical examination or something else. The principle of consent is an important part of medical ethics and international human rights law.
 In Open Hospital there are three types of Patient consent:
...
- Consent to additional services - to introduce a flag in the patient registration form to record the patient consensus for additional services (optional, for the Portal)
This consent should also be de-selectable, which implies the opt-out from the additional services (performed by the Patient Portal Connector)
...
The last column, *LOCKED*, if checked indicates that the user is cuurently locked out from logging into the system.
