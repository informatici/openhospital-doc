...
This means that the lot has to be defined within the inventory and this can be achieved by selecting the inventory row and by clicking on the *[.underline]##L##ot* button:
...
- *Yes, all medicals*: the system checks if new movements are made on the main store for any medical and will show the changes in a new dialog. See below.
...
By clicking the *[.underline]##y##es* button, the system will convert all differences between real and theoretical quantities into charge/discharge movements and signals the process is completed with the following information message:
...
To view a ward inventory, highlight the inventory in the *_Manage Ward Inventory_* window. Once the inventory is  highlighted, click the *[.underline]##V##iew* button which will then show the *_View Inventory_* window. 
