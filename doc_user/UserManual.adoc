...
During modication you have possibility to validate the inventory By press on Validate button. After some seconde you will have the Dialog below.
...
===== 4.5.2.2 Edit Inventory ([.underline]##E##dit)

===== 4.5.2.3 View Inventory ([.underline]##V##iew)

===== 4.5.2.4 Delete Inventory ([.underline]##D##elete)
