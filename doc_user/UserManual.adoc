...
* *Result*: the result of the operation; it is mandatory and no value is preselected
...
It is possible to record several operations at once. The buttons *[.underline]##A##dd*, *C[.underline]##l##ear* and *[.underline]##D##elete* at the top right of the table allow the manipulation of the items of the table.

To add a new operation, enter the data as mentioned above and click on the button *[.underline]##A##dd*.

To modify an operation, select its line in the table by clicking on it: the form is filled with the data of the selected line and the *[.underline]##A##dd* button changes to *[.underline]##U##pdate*. Modify the data and click on the button *[.underline]##U##pdate*. The button *C[.underline]##l##ear* empties the form and restores the *[.underline]##A##dd* button.

WARNING: Clicking on the button *[.underline]##A##dd* (or *[.underline]##U##pdate*) just adds the operation to the table; it is not yet permanently recorded.

To delete a line from the table, select the line to delete by clicking on it (it automatically highlights),
then click on the button *[.underline]##D##elete* and confirm the deletion. Deleting a line just added to the table only removes it from the table;
deleting an already saved operation takes effect immediately after the confirmation.

When finished, click on the button *[.underline]##S##ave* below the table to permanently record the added or updated lines.
