...
** *Disease*: Select a specific disease, or all diseases, or search using partial matches by typing some letters in the search field
...
* radio box (5) to distinguish whether an individual is new (*New Attendance*)
 ...
 provided for and/or addressed. This could be their initial visit or their n-th
 ...
 event is recorded as a *New Attendance* and the doctor sutures the wound and
 ...
 then created with the *Re-Attendance* flag set as this visit is a
 continuation of previous visit and medical problem.
...
* If editing an old OPD, it is possible to change everything except the patient which the OPD refers to, and the "New Attendance" radio box.
...
In this window enter a description for the custom item (in the example below, it is “Number of days of hospitalization”).
...
Merging data of two patients requires the highlighting of both of them in the *_Patient Browser_* window.
