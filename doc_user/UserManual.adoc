...
image:extracted-media/media/image243.png[Dicom info.PNG,width=517,height=366]

*[.underline]#N.B.#* There's no *Edit DICOM*, so if you make a mistake, please *Delete DICOM* and re-*Load DICOM* again.
