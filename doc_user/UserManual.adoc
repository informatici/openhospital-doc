...
To insert an inventory row for a set of medicals, useful for rotational inventories, click the SELECT button. This will open the *_Lot Information_* window.
