...
==== 14.2.2 Discharge Types (Discha[.underline]##r##ge Type)

Once the *Discha[.underline]##r##ge Type* button from the *_Types_* menu is pressed, the *_Discharge Type Browser_* window shown below appears:
