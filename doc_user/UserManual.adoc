...
Deleted Medical Types will be marked as “Deleted” and will not be shown in the list of Medical Types in the application. User cannot mark a Medical Type as “Deleted” if it is still used somewhere in the application.
