...
- Consent to additional services: this consent is for the opt-in and opt-out from additional services the hospital provides (e.g. special mailing, contacts, etc...)
- Administrative flag: this flag is important if the hospital wants to flag the patient due to other administrative reason (e.g. undue payments, technical issues, etc...)
