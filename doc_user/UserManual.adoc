...
All functions available under *[.underline]##I##nventory* are accessible from the *_Inventory Browser_* window. By default, the system shows all the inventories recorded in the period.
