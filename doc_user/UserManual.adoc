...
* *Supplier*: the origin of the pharmaceutical. Suppliers flagged as _virtual_ (e.g. INVENTORY, LOST, BROKEN, EXPIRED) are listed with a _(virtual)_ suffix and can be selected to record charges that do not come from a real supplier
...
* *Destination*: the ward where the discharged medical will be affected. Wards flagged as _virtual_ (e.g. INVENTORY, LOST, BROKEN, EXPIRED) are listed with a _(virtual)_ suffix and can be selected as the destination of discharges that do not target a physical ward
...
* *Virtual Ward*: if checked, the ward represents a virtual destination (e.g. INVENTORY, LOST, BROKEN, EXPIRED) rather than a physical ward. Virtual wards are shown with a _(virtual)_ suffix when selected as a destination for Main Store discharging movements.
...
* *Virtual Supplier*: if checked, the supplier represents a virtual origin (e.g. INVENTORY, LOST, BROKEN, EXPIRED) rather than a real supplier. Virtual suppliers are shown with a _(virtual)_ suffix when selected as the origin of a Main Store charging movement.
