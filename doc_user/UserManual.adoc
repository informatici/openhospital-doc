...
- Administrative consent: administrative consent order means a legal agreement signed by the Director and the owner or operator of a Poultry Feeding Operation.
