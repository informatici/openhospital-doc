...
* If editing an old OPD, it is possible to change everything except the patient to whom the OPD, and the "New Attendance" radio box.
...
The *Worksheet* function allows for the management and printing of the list of appointments scheduled.
