...
* *Charge Type*: the charge movement type used for the charge movement (when theoretical quantity < real quantity).
* *Supplier*: the supplier used for the charge movement.
* *Discharge Type*: the discharge movement type used for discharge movement (when theoretical quantity > real quantity).
* *Destination*: the ward used for the discharge movement.
