...
*Non-Operational* movements include transactions that do not directly impact the core operational activities of the warehouse. These movements are typically one-time or irregular transactions that are not part of the regular inventory management process. They include adjustments due to inventory discrepancies.
...
Operational will be used to calculate effective consumptions in some reports, like the Average Monthly Consumption report (see <<pharmaceuticals,Pharmaceuticals>>). 
