...
[#3-default-main-menu]
[caption="Main Menu: "]
image::extracted-media/media/image0_DefaultMainMenu.png[Default Main Menu,width=250,height=627]
...
image:extracted-media/media/image9.png[image,width=800,height=319]
...
image:extracted-media/media/image10.png[image,width=810,height=337]
...
[caption="Sub Menu: "]
|===
|image:extracted-media/media/image0_DefaultMainMenu.png[Default Main Menu,width=250,height=627]|image:extracted-media/media/image16.png[Sub-Menu,width=256,height=212]
|===
...
_*[.underline]#NB#*: The Lot definition can be set as automatic by changing the flag AUTOMATICLOT\_IN_ in configuration file, so every new charging movement will automatically create a new lot; anyway, the Expiring Date must always be provided._ _Ask to your Administrator how to do it or read the Administrator’s Guide._
...
_*[.underline]#NB#*: The Lot definition can be set as automatic by changing the flag AUTOMATICLOT_OUT_ in configuration file, so every new discharging movement will automatically select a suitable lot for the operation according to the expiring date. If the first selected lot is does not contain enough quantity to serve the discharging movement, several discharging movements may be generated._ _Ask to your Administrator how to do it or read the Administrator’s Guide._
...
_*[.underline]#NB#*: Since v1.11.0 lot management is compulsory when rectifying quantities in wards._
...
_*[.underline]#NB#*: The Lot selection can be enabled or disabled (set as automatic) by changing the flag AUTOMATICLOTWARD_TOWARD_ in configuration file, so every new discharging movement will automatically select a suitable lot for the operation according to the expiring date (FEFO). If the first selected lot is does not contain enough quantity to serve the discharging movement, several discharging movements may be generated if  the quantity laying in other lots can suite the request._ _Ask to your Administrator how to do it or read the Administrator’s Guide._
...
image:extracted-media/media/image43b.png[image,width=528,height=339]
...
image:extracted-media/media/image45.png[Laboratory_new_proc1.PNG,width=309,height=340]image:extracted-media/media/image46.png[Laboratory_new_proc2.PNG,width=309,height=340]image:extracted-media/media/image46b.png[Laboratory_new_proc3.PNG,width=309,height=340]
...
image:extracted-media/media/image50.png[image,width=531,height=530]
...
[caption="Sub Menu: "]
|===
|image:extracted-media/media/image0_DefaultMainMenu.png[Default Main Menu,width=250,height=627]|image:extracted-media/media/image52.png[Accounting Sub-Menu,width=185,height=167]
|===
...
image:extracted-media/media/image244.png[image,width=400,height=456]
...
In case of multi-frame DICOM you can select a whole folder

image:extracted-media/media/image106b.png[Dicom open multi-frame.PNG,width=517,height=366]
...
image:extracted-media/media/image243.png[Dicom info.PNG,width=282,height=200]
...
[caption="Sub Menu: "]
|===
|image:extracted-media/media/image0_DefaultMainMenu.png[Default Main Menu,width=250,height=627]|image:extracted-media/media/image0_DefaultGeneralDataMenu.png[Sub-Menu,width=185,height=527]
|===
...
|===
|image:extracted-media/media/image0_DefaultGeneralDataMenu.png[General Data Sub-Menu,width=185,height=527]|image:extracted-media/media/image0_DefaultGeneralDataTypesMenu.png[General Data Types Menu,width=235,height=707]
|===
...
image:extracted-media/media/image242.png[Discharge Types.PNG,width=432,height=194]
...
image:extracted-media/media/image170b.png[image,width=600,height=178]

So, the two remaining possibilities are showed below:

image:extracted-media/media/image171.png[image,width=321,height=181]image:extracted-media/media/image171b.png[image,width=321,height=181]
