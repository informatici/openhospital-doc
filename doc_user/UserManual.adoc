...
* *USER*: the user who initially created or at later time updated the bill
...
* *Select month*: a report that shows a statement with all paid and unpaid bills within a specified month
