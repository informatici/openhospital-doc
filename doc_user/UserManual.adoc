...
press the *[.underline]##T##herapy* button. The specific window for therapy management of the selected patient appears. The window has no name, we call it the *_Therapy_* window.
...
With this function you can produce all reports listed in the previous paragraph. Once you press the *S[.underline]##t##atistics* button on the main menu the *_Report Launcher_* window shown below appears:
