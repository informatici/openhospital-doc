...
Depending on the operating system you have, there are several software tools to download to install and manage a MySQL server. In most cases just a standard installation package of the software is needed, paying attention to configuration options during the installation process.
...
Next create the database user with password and grant the necessary permissions:
