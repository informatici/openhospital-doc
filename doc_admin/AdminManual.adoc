...
* <<server,2.3 OH - SERVER mode (portable)>>: multi computer setup, with the central database created by Open Hospital itself (click and run)

TIP: "2.2 OH - PORTABLE mode" can be also used to test the application.
