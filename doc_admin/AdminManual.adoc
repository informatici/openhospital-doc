= Open Hospital 1.11.5 - Administrator’s Guide
:icons: font
:stem:
:toc: left
:toclevels: 4
...
A downloaded compressed archive can be opened on most operating systems by just double-clicking on it.
...
After uncompressing the package, browse to the extracted directory (example given for version 1.11.5):

* on Linux:
----
cd /home/OH/OpenHospital-v1.11.5
----
* on Windows:
----
cd C:\Users\OH\OpenHospital-v1.11.5
----
...
[source,shell]
----
C:\WINDOWS> cd C:\Users\OH\OpenHospital-v1.11.5\sql

C:\Users\OH\OpenHospital-v1.11.5\sql
...
[source,shell]
----
C:\Users\OH\OpenHospital-v1.11.5\sql> mysql -u root -p [-h hostname/ip address]
Enter password: *****
----
...
* *oh/rpt_base* – contains the JasperReports® *reports* used by Open Hospital
* *oh/rpt_base/PDF* – contains the reports defined in oh/rpt_base generated by Open Hospital in PDF format
* *oh/rpt_stat* – contains the JasperReports® *reports* used by Open Hospital in section Statistics
* *oh/rpt_stat/PDF* – contains the reports defined in oh/rpt_stat generated by Open Hospital in PDF format
* *oh/rpt_extra* – contains the JasperReports® *reports* defined by the user
* *oh/rpt_extra/PDF* – contains the reports defined in oh/rpt_extra generated in PDF format    
...
* rpt_base/ folder contains all the hardcoded reports used by the applicatione
...
* some reports could have also more than one *.properties* file that works for the localization, it means that the report has been translated to appear in more languages (default is English). At least the default *.properties* file should contain the *jTitle* property that define the name visualized in the Open Hospital application, otherwise the application will show the name of the *.jasper* file.
...
== 5 Installing Open Hospital 1.11.5 in Eclipse EE

The OH source code is available on GitHub at the following links:

* https://github.com/informatici/openhospital-core/tree/v1.11.5[openhospital-core]
* https://github.com/informatici/openhospital-gui/tree/v1.11.5[openhospital-gui]
* https://github.com/informatici/openhospital-doc/tree/v1.11.5[openhospital-doc]
...
are already installed on the computer, this chapter will focus on cloning version 1.11.5 into the Eclipse J2EE (or Eclipse EE)
environment.
...
[source,shell]
----
C:\WINDOWS\system32> cd C:\Users\OH\OpenHospital.1.11.5\sql

C:\Users\OH\OpenHospital.1.11.5\sql>
----
...
[source,shell]
----
C:\Users\OH\OpenHospital.1.11.5\sql> mysql –u root -p
