= Open Hospital 1.14.2 - Administrator’s Guide
<<<
:icons: font
:stem:
:toc: left
...
* https://github.com/informatici/openhospital-core/tree/v1.14.2[openhospital-core]
* https://github.com/informatici/openhospital-gui/tree/v1.14.2[openhospital-gui]
* https://github.com/informatici/openhospital-doc/tree/v1.14.2[openhospital-doc]
...
are already installed on the computer, this chapter will focus on cloning version 1.14.2 into the Eclipse J2EE (or Eclipse EE)
environment.
