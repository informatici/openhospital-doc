...
After uncompressing the package, browse to the extracted directory (example given for version 1.15.1):

* on Linux:
----
cd /home/OH/OpenHospital-v1.15.1
----
* on Windows:
----
cd C:\Users\OH\OpenHospital-v1.15.1
----
...
[source,shell]
----
C:\WINDOWS> cd C:\Users\OH\OpenHospital-v1.15.1\sql

C:\Users\OH\OpenHospital-v1.15.1\sql
...
[source,shell]
----
C:\Users\OH\OpenHospital-v1.15.1\sql> mysql -u root -p [-h hostname/ip address]
Enter password: *****
----
...
== 5 Installing Open Hospital 1.15.1 in Eclipse EE

The OH source code is available on GitHub at the following links:

* https://github.com/informatici/openhospital-core/tree/v1.15.1[openhospital-core]
* https://github.com/informatici/openhospital-gui/tree/v1.15.1[openhospital-gui]
* https://github.com/informatici/openhospital-doc/tree/v1.15.1[openhospital-doc]
...
are already installed on the computer, this chapter will focus on cloning version 1.15.1 into the Eclipse J2EE (or Eclipse EE)
environment.
...
[source,shell]
----
C:\WINDOWS\system32> cd C:\Users\OH\OpenHospital-v1.15.1\sql\update

C:\Users\OH\OpenHospital-v1.15.1\sql\update>
----
...
[source,shell]
----
C:\Users\OH\OpenHospital-1.15.1\sql\update> mysql –u root -p [-h hostname/ip address]
