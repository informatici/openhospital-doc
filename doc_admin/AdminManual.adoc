...
Open Hospital is packaged with a login "hint" when the _default_credentials.properties_ file is found. To remove the hint, is enough to delete this file.
...
NOTE: is always recommended to change the admin user password in production
