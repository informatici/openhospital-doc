...
Starting with version 1.12, Open Hospital can be lauched in SERVER mode. SERVER mode allows to launch a local instance of the database server and listen for connections from other clients.
...
Open Hospital can produce a report about the Patient Examinations.
