...
* *Portable Open Hospital for Linux* platforms (embedding Java JDK and MySQL for Linux, 32 or 64bit)
* *Portable Open Hospital for Windows* platforms (embedding Java JDK and MySQL for Windows)
