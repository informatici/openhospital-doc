...
The value of PASSWORDLOCKTIME is the number of minutes that an account is locked after failing to specify the correct password and the number of times specified by
