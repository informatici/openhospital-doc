= Open Hospital 1.14.0 - Administrator’s Guide
<<<
:icons: font
:stem:
:toc: left
...
After uncompressing the package, browse to the extracted directory (example given for version 1.14.0):

* on Linux:
----
cd /home/OH/OpenHospital-v1.14.0
----
* on Windows:
----
cd C:\Users\OH\OpenHospital-v1.14.0
----
...
[source,shell]
----
C:\WINDOWS> cd C:\Users\OH\OpenHospital-v1.14.0\sql

C:\Users\OH\OpenHospital-v1.14.0\sql
...
[source,shell]
----
C:\Users\OH\OpenHospital-v1.14.0\sql> mysql -u root -p [-h hostname/ip address]
Enter password: *****
----
...
== 5 Installing Open Hospital 1.14.0 in Eclipse EE

The OH source code is available on GitHub at the following links:

* https://github.com/informatici/openhospital-core/tree/v1.14.0[openhospital-core]
* https://github.com/informatici/openhospital-gui/tree/v1.14.0[openhospital-gui]
* https://github.com/informatici/openhospital-doc/tree/v1.14.0[openhospital-doc]
...
are already installed on the computer, this chapter will focus on cloning version 1.14.0 into the Eclipse J2EE (or Eclipse EE)
environment.
...
[source,shell]
----
C:\WINDOWS\system32> cd C:\Users\OH\OpenHospital-v1.14.0\sql\update

C:\Users\OH\OpenHospital-v1.14.0\sql\update>
----
...
[source,shell]
----
C:\Users\OH\OpenHospital.1.14.0\sql\update> mysql –u root -p [-h hostname/ip address]
