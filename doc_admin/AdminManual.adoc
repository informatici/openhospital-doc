...
To define a new report with Jaspersoft® Studio it is possible to start from scratch or modify an existing Open Hospital report:

* open the jrxml file
* edit it
* re-compile the jrxml file in jasper format (generate the .jasper file)
* place the jasper report file in the report folder and used by the Open Hospital application (rpt_extra/)
* the OH application will show the custom reports in the Statistics menu.
