= Open Hospital 1.11.2 - Administrator’s Guide
:icons: font
:stem:
:toc: left
:toclevels: 4
...
After uncompressing the package, browse to the extracted directory (example given for version 1.11.2):

* on Linux:
----
cd /home/OH/OpenHospital-v1.11.2
----
* on Windows:
----
cd C:\Users\OH\OpenHospital-v1.11.2
----
...
[source,shell]
----
C:\WINDOWS> cd C:\Users\OH\OpenHospital-v1.11.2\sql

C:\Users\OH\OpenHospital-v1.11.2\sql
...
[source,shell]
----
C:\Users\OH\OpenHospital-v1.11.2\sql> mysql -u root -p [-h hostname/ip address]
Enter password: *****
----
...
include::https://raw.githubusercontent.com/informatici/openhospital/master/oh-bundle/OH-README.md[lines=25..374,leveloffset=+2]
...
Backup of the client *data files*, especially for "PORTABLE" mode, can be performed by saving/copying the *"data"* folder (including all subfolders) found under the main OH installation folder.
...
NOTE: The properties files can be automatically generated/overwritten at any Open Hospital startup, by setting the GENERATE_CONFIG_FILES option to "on" in the **oh.sh / oh.ps1** scripts.
...
NOTE: The OH_LANGUAGE can be automatically generated/overwritten at any OpenHospital startup, by setting the GENERATE_CONFIG_FILES option to "on" in the  **oh.sh / oh.ps1** scripts.
...
NOTE: The DOC_DIR setting can be automatically generated/overwritten at any OpenHospital startup, by setting the GENERATE_CONFIG_FILES option to "on" in the **oh.sh / oh.ps1** scripts.
...
|===
|Key |Default Value |Valid Values
|PATIENTPHOTO |DB |DB, FILE
|===

Open Hospital can save the user's profile picture in the database or on the file system.

If the PATIENTPHOTO parameter is set to FILE, Open Hospital searches for the profile picture in the path specified in he PATIENTPHOTO parameter. 

If the PATHPHOTO parameter is set to DB, then Open Hospital searches for the patient profile picture in the DB.


By default, PATIENTPHOTO is set to DB.

NOTE: An application restart is required to apply the modified setting.

==== 3.1.36 PATIENTPHOTOPATH

If PATIENTPHOTO is equal to FILE, then it is mandatory to set the PATIENTPHOTOPATH that should contain the directory where the patient profile pictures will be stored.

==== 3.1.37 MAXPROFPICFILESIZEBYTES
Specifies the maximum size of the patient's profile photo.
...
NOTE: The _database.properties_ file can be automatically generated/overwritten at any Open Hospital startup, by setting the GENERATE_CONFIG_FILES option to "on" in the **oh.sh / oh.ps1** scripts.
...
NOTE: The _dicom.properties_ file can be automatically generated/overwritten at any **oh.sh / oh.ps1**  startup, by setting the GENERATE_CONFIG_FILES option to "on" in the **oh.sh / oh.ps1** scripts.
...
NOTE: The _log4j.properties_ file can be automatically generated/overwritten at any Open Hospital startup, by setting the GENERATE_CONFIG_FILES option to "on" in the **oh.sh / oh.ps1** scripts.
...
== 5 Installing Open Hospital 1.11.2 in Eclipse EE

The OH source code is available on GitHub at the following links:

* https://github.com/informatici/openhospital-core/tree/v1.11.2[openhospital-core]
* https://github.com/informatici/openhospital-gui/tree/v1.11.2[openhospital-gui]
* https://github.com/informatici/openhospital-doc/tree/v1.11.2[openhospital-doc]
...
are already installed on the computer, this chapter will focus on cloning version 1.11.2 into the Eclipse J2EE (or Eclipse EE)
environment.
...
[source,shell]
----
C:\WINDOWS\system32> cd C:\Users\OH\OpenHospital.1.11.2\sql

C:\Users\OH\OpenHospital.1.11.2\sql>
----
...
[source,shell]
----
C:\Users\OH\OpenHospital.1.11.2\sql> mysql –u root -p
