...
**MariaDB installer does not include Bin Directory in Windows PATH; it must be added manually to Windows system variable PATH**
...
If the *Include Bin Directory In Windows PATH* is selected during the installation process, the MySQL client can be run everywhere in the system.
