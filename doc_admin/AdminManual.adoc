...
This manual describes the tasks needed to use the application. All the information needed to use the application software are not included; please refer to the _User’s Guide_, supplied with the application software.

<<<

== 2 Introduction

In the following chapters all the information needed to install, configure, run and mantain an Open Hospital installation are presented.
The information included allow enabling and disabling functionality as well as managing users and groups.
