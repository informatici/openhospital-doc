...
include::https://raw.githubusercontent.com/informatici/openhospital/master/OH-README.md[lines=21..197,leveloffset=+2]

NOTE: Folder structure and known issues are found at:
https://github.com/informatici/openhospital/blob/master/OH-README.md
...
** OH-linux-changelog.md (changelog portable-linux)
** OH-README.md (README portable-linux)
...
** OH-README.md (README portable-windows)
** OH-win-changelog.md (changelog portable-windows)
