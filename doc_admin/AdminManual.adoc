...
The oh.sh / oh.ps1 set of scripts can download and install the latest JRE available by downloading it from internet; it is also possibile to install it
...
Restore of the database is also possible; See script help for more information.
