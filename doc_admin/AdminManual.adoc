...
Open Hospital is deployed as a desktop application that can be used in a standalone (portable), single user mode
...
The procedure includes the installation of the JRE (Java Runtime Environment), the MySQL Server and the creation of the database through the execution of a script in the folder sql/ within the .zip file folders.
