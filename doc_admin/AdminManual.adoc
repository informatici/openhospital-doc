...
Open Hospital is a client application that can be used in two modalities: 
...
** <<setup,Setup>> and <<run,run>> the application to point to the database server using the hostname or the IP address
