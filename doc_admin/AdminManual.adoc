...
Default examination module configuration is available in the _examination.properties.dist_ file:
...
Default SMS configuration is available in the _sms.properties.dist_ file:
...
Default Telemetry configuration is available in the _telemetry.properties.dist_ file:
...
Default Text printer configuration is available in the _txtPrinter.properties.dist_ file:
...
Default XMPP module configuration is available in the _xmpp.properties.dist_ file:
