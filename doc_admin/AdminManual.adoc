...
_*Warning*_: since version v1.11, OpenHospital Jasper reports are produced with TIBCO Jaspersoft Studio 6.14.0 or greater.

For previous OpenHospital's versions, in order to have compliant and fully-working reports for OpenHospital you must use iReport® version 3.0.0 (Classic) to edit and compile them.
