...
Open Hospital has a folder tree hierarchy which is shown here, where *_<version>_* is replaced with the current Open Hospital version:
...
* *oh/rsc* – contains the *resources* of Open Hospital, like configuration files and other stuff
...
* *data* – contains all the data (database, logs) - created after the first startup
* *data/db* – contains the database files
* *data/logs* – contains all the logs
* *data/dicom* – contains all the logs
* *data/dump* – contains the backups
...
=== 4.1 Folder tree in Open Hospital portable for Linux (32 and 64bit)
...
=== 4.2 Folder tree in Open Hospital portable for Windows (32bit)
