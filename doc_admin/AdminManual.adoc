...
==== 3.1.39 SESSIONTIMEOUT
The following table shows the default value and the allowed ones:

[cols=",,",options="header",]
|===
|Key |Default Value | Allowed Values
|STRONGLENGTH |300000 | positive integer value
|===

The value SESSIONTIMEOUT represents the time of user inactivity beyond which the software application performs the automatic logout.
