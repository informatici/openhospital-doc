...
Backup of the client data and configuration files, especially for "PORTABLE" mode, can be performed by saving the "data" folder (including all subfolders) present under the main OH path.
