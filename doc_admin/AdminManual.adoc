...
The software acts as a client application. The server part utilizes a DataBase Management System (DBMS) to archive, share and present the information. The free and open-source MariaDBfootnode:[See https://www.mariadb.org] MariaDB is the database server of choice.
...
Restore of the database is also possible; See script help for more informations.
