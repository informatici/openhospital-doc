...
Open Hospital main menu can be customized by adding a logo of choice. To test the feature, rename the image file _logo_hospital_example.png_ found in the _oh/rsc/images_ folder to _logo_hospital.png_:

image:OH-main_menui_log.png[OH main menu]
...
The OH source code is available on GitHub at these links:

https://github.com/informatici/openhospital-core/tree/v1.11.2[openhospital-core],
https://github.com/informatici/openhospital-gui/tree/v1.11.2[openhospital-gui], and
