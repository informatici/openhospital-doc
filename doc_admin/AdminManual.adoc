...
Depending on the choosen operating system and architecture, you will also find the directories containing the needed external applications and libraries, like MySQL/MariaDB and Java JRE:

** _jdk-11.0.9+11-jre/_ or _zulu11.43.21-ca-jre11.0.9-<operating_system>_<arch>/ - Java Virtual Machine
