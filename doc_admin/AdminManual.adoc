...
[source,shell]
----
C:\WINDOWS\system32> cd C:\Users\OH\OpenHospital.1.13.0\sql\update

C:\Users\OH\OpenHospital.1.13.0\sql\update>
----
...
[start=7]
. Execute all the SQL scripts from the current OH version until the new one:
