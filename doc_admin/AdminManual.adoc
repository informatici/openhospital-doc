...
A default examination module configuration is available in the _examination.properties.dist_ file:
...
A default SMS communication module configuration is available in the _sms.properties.dist_ file:
...
A default telemetry configuration is available in the _telemetry.properties.dist_ file:
...
A default text printer configuration is available in the _txtPrinter.properties.dist_ file:
...
A default XMPP module configuration is available in the _xmpp.properties.dist_ file:
