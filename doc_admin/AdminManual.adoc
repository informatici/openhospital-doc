...
==== 3.1.1 Prerequisites - Compatibility matrix

In the following table the compatibility list for Open Hospital is presented:
include::./compatibility_matrix.adoc[]
...
No other configuration is needed. Additional options can be shown by executingi:

* on Linux: *oh.sh -h*
* on Windows: *oh.bat --help*
