= Open Hospital 1.11.3 - Administrator’s Guide
:icons: font
:stem:
:toc: left
:toclevels: 4
...
pass:[<br>][.small]#Administrator’s Guide, &#169; 2022 by https://www.informaticisenzafrontiere.org/[Informatici Senza Frontiere Onlus]#
...
After uncompressing the package, browse to the extracted directory (example given for version 1.11.3):

* on Linux:
----
cd /home/OH/OpenHospital-v1.11.3
----
* on Windows:
----
cd C:\Users\OH\OpenHospital-v1.11.3
----
...
[source,shell]
----
C:\WINDOWS> cd C:\Users\OH\OpenHospital-v1.11.3\sql

C:\Users\OH\OpenHospital-v1.11.3\sql
...
[source,shell]
----
C:\Users\OH\OpenHospital-v1.11.3\sql> mysql -u root -p [-h hostname/ip address]
Enter password: *****
----
...
[source,shell]
----
MariaDB> source create_all_en.sql
----
...
include::https://raw.githubusercontent.com/informatici/openhospital/master/oh-bundle/OH-README.md[lines=25..413,leveloffset=+2]
...
** _zulu8.<version>-<operating_system>_<arch>/ - Java Virtual Machine
...
== 5 Installing Open Hospital 1.11.3 in Eclipse EE

The OH source code is available on GitHub at the following links:

* https://github.com/informatici/openhospital-core/tree/v1.11.3[openhospital-core]
* https://github.com/informatici/openhospital-gui/tree/v1.11.3[openhospital-gui]
* https://github.com/informatici/openhospital-doc/tree/v1.11.3[openhospital-doc]
...
are already installed on the computer, this chapter will focus on cloning version 1.11.3 into the Eclipse J2EE (or Eclipse EE)
environment.
...
[source,shell]
----
C:\WINDOWS\system32> cd C:\Users\OH\OpenHospital.1.11.3\sql

C:\Users\OH\OpenHospital.1.11.3\sql>
----
...
[source,shell]
----
C:\Users\OH\OpenHospital.1.11.3\sql> mysql –u root -p
