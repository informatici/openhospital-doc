...
The information included also allow enabling and disabling functionality as well as managing users and groups.
All the information needed to use the application software are not included; please refer to the _User’s Guide_, supplied with the application software.
