...
To migrate a portable installation to a a full Client-Server configuration, keeping the existing data, the following steps must pe performed:
...
. Close Open Hospital
. Install the database server as outlined heew <<database-server,Database Server and Open Hospital DB>>
