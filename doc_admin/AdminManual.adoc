...
Before starting, checke the following software compatibility matrix, in order to verify the external software versions needed to run Open Hospital and the current available extended features for every version, architecture and operating system.
...
===== 3.1.3.3 MySQL configuration - networking
...
Next create the database user with password, the main OH database and grant the necessary permissions:
...
The script creates the OH databasea structure and populates it with default data.
...
NOTE: Remember to set the updated database password also in the openhospital configurazion files.
...
WARNING: Open Hospital Jasper reports are produced with TIBCO Jaspersoft Studio 6.14.0 or later.
